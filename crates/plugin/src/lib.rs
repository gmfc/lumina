...
pub use lsp::{
    LspCodeAction, LspCodeLens, LspCompletionItem, LspDiagnostic, LspFoldingRange, LspHighlight,
    LspInlayHint, LspLocation, LspNavItem, LspRequestKind, LspSemanticToken, LspSeverity,
